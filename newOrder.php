<?php
    ...
    case 1:
        $r_msg = '<div class="ui success message">
								  ...
								  <p>Vendor added to our database. You may begin using it immediately to submit purchase requisitions</p>
								</div>';
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
    	...
    	<h1><i class="fa fa-shopping-bag" aria-hidden="true"></i>  Create Order</h1>
       <div id='messagebox'><?php echo $r_msg;?></div>
...
<form action="inserts/newOrderController.php" method="post" enctype="multipart/form-data" name="orderForm"  id="orderForm" data-dmx-validate="true"  class="ui form">
...
<div class="form-group has-warning has-feedback">
      <input id="VENDOR_NAME" name="VENDOR_NAME" placeholder="enter vendor name" class="ui form-control focusedInput" type="text" required="true" style="text-transform:capitalize;padding-top:5px" autocomplete="off"  aria-describedby="inputWarning2Status"/>
...
<div class="col-md-3"><div class="form-group">
  <label for="frsNumber" class="control-label required">KFS Account Number</label>
    ...
    <input type="text" class="ui form-control focusedInput" id="frsNumber" name="frsNumber" placeholder="Valid KFS accounts only" required="true"  data-rule-minlength="7" data-rule-maxlength="9">
 ...
 <div class="controls">
        <input class="datepicker form-control" name="dateRequiredBy" id="dateRequiredBy" type="text" placeholder="MM/DD/YYYY" required="" format="date"/>
 </div>
...
<div class="row" id="approver_sel">
  ...
  <div class="col-md-3"><div class="form-group">
  			<label class="control-label required" for="approver"><i class="fa fa-question-circle" aria-hidden="true"   data-toggle="popover" data-content="Your group approver is selected by default, to have someone else approve the order, select OTHER"></i> Approver</label>
      				...
      				<?php include_once dirname(__FILE__) . '/inserts/getApprovers.php';?>
...
<div class="col-md-3"><div class="form-group">
  			<label for="preapprover" class="control-label"><i class="fa fa-question-circle" aria-hidden="true"   data-toggle="popover" data-content="If OTHER was selected as approver, select an alternate approver here"></i> Approver (Other)</label>
  				<div class="controls">
					...
					<?php include_once dirname(__FILE__) . '/inserts/getAllApprovers.php';?>
 ...
 <div class="col-md-3">
  ...
  <div class="controls ">
    <select id="shipping_type" name="shipping_type" class="ui fluid dropdown" required="">
      <option value="Cheapest Available" selected="selected" >Cheapest Available</option>
  ...
  <div class="controls ">
    <select id="shipping_location" name="shipping_location" class="ui fluid dropdown" required="">
      <option value="Building-91" selected="selected" >Chem-091</option>
...
<div class="col-md-3">
 ...
 <div class="col-md-3">
  ...
  <div class="radio">
       <label class="radio-custom radio-inline" data-initialize="radio" id="RadioActive-0">
        <input name="RadioActive" type="radio" value="No" checked> <span class="radio-label"> No</span>
      </label>
      <label class="radio-custom radio-inline" data-initialize="radio" id="RadioActive-1">
        <input name="RadioActive" type="radio" value="Yes"> <span class="radio-label"> Yes</span>
 ...
 <div class="col-md-6">
  ...
  <input type="text" id="orderQuote" name="orderQuote">
  ...
  <label class="control-label" for="order_notes">Purchaser Comments</label>
    ...
    <textarea class="ui form-control" id="order_notes" name="order_notes" rows="5" placeholder="place any comments, justification/additional notes here"></textarea>
...
<button type="submit" class="btn btn-checkout right-button" id="exsbm"><i class="fa fa-floppy-o" aria-hidden="true"></i>  SAVE AND CONTINUE</button>
</div>

       <input type="hidden" name="requestor" value="<?php echo $_SESSION['fullName'];?>">
       <input type="hidden" name="REQUESTOR_PHONE" value="<?php echo $_SESSION['telephone'];?>">
        <input type="hidden" name="REQUESTOR_EMAIL" value="<?php echo $_SESSION['email'];?>">
       <input type="hidden" name="requestorID" value="<?php echo $_SESSION['username'];?>">
       <input type="hidden" name="approver_group" value="<?php echo $_SESSION['approver_group'];?>">
     ...
     <div id="modal-message"></div>
          <form id="frmAddVendor"  name="frmAddVendor" action="inserts/newVendorController.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="ui form-control" id="VENDOR_NAME" name="VENDOR_NAME"
                    placeholder="" required="" type="text">
                </div><!-- Text input http://getbootstrap.com/css/#forms -->
                <div class="form-group">
                    <label class="control-label" for="VENDOR_EMAIL">
                    Email Address</label>
                    <input class="ui form-control" id="VENDOR_EMAIL" name="VENDOR_EMAIL"
                    placeholder="A valid sales contact email address is required for vendors outside the US" type="email">

                </div><!-- Text input http://getbootstrap.com/css/#forms -->
                <div class="form-group">
                    <label class="control-label required" for="VENDOR_PHONE">
                    Telephone Number</label>
                    <input class="ui form-control" id="VENDOR_PHONE" name="VENDOR_PHONE"
                    placeholder="" required="" type="text">
                </div><!-- Text input http://getbootstrap.com/css/#forms -->
                <div class="form-group">
                    <label class="control-label required" for="VENDOR_URL">
                    Website URL</label>
                    <input class="ui form-control" id="VENDOR_URL" name="VENDOR_URL"
                    placeholder="http://www.websiteurl.com" required="" type="url">
                </div><!-- Button http://getbootstrap.com/css/#buttons -->

              <div class="modal-footer">
           <button class="ui button" name="sbtAddVendor" id="sbtAddVendor">Submit</button>
           <button type="submit" class="ui button" data-dismiss="modal">Close</button>
      </div>
        </form>
